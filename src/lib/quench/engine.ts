...
export function createAgentRun(args: {
  ...
  const native: NativeReport = {
    ...
    benchmarkWarmup: args.report.benchmarkWarmup,
    medianMs: args.report.medianMs,
    p95Ms: args.report.p95Ms,
    minMs: args.report.minMs,
    maxMs: args.report.maxMs,
    spreadMs: args.report.spreadMs,
    stdDevMs: args.report.stdDevMs,
    stabilityWarning: args.report.stabilityWarning ? String(args.report.stabilityWarning) : null,
