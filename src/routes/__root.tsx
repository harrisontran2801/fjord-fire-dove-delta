...
const APP_NAME = "Quench";
const APP_DESC =
  "Local-first optimizer for Linux ELF projects. Runs a reproducible local optimization pipeline when the native agent is connected.";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: `${APP_NAME} — Local-first software optimization` },
